...
from mcts_orig import MCTSPlayer as MCTS_Pure
# from mcts_alphazero import MCTSPlayer
# from mcts_ucb1 import MCTSPlayer    # for ucb tuned
from mcts_ucb2 import MCTSPlayer  # for KL UCB
from policy_value_net664 import PolicyValueNet
# from policy_value_net_residual import PolicyValueNet

DEBUG = False
logfile_name = '664.log'
# model_path = './models_664_origpure_nofrust/current_policy_3450.model'
        ...
        try:
            for i in range(self.game_batch_num):
                ...
                if (i+1) % self.check_freq == 0:
                    ...
                    self.policy_value_net.save_model('./models/current_policy_{}.model'.format(i+1))
                    if win_ratio > self.best_win_ratio:
                        print("New best policy!!!!!!!!")
                        self.best_win_ratio = win_ratio
                        # update the best_policy
                        self.policy_value_net.save_model('./models/best_policy_{}.model'.format(i+1))
                        if (self.best_win_ratio > 0.8 and
                                self.pure_mcts_playout_num < 25000):
